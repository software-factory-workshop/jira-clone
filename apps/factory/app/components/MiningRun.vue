  ...
  <div class="panel mining-run">
    ...
    <div v-else>
      ...
      <div v-if="output?.report" class="findings">
        ...
        <div class="mining-actions"><UButton v-if="!output.proposals?.length && !output.noProposalReason" icon="i-lucide-file-pen-line" @click="draft">Use findings in a draft</UButton><UButton variant="outline" color="neutral" @click="startNew">New investigation</UButton></div>
