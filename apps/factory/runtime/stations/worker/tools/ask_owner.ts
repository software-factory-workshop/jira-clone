...
import { currentRevision, requireStation, stationDeliveryId, stationRequest, workerRequest } from "../../../lib/station-access";
...
export default defineTool({
  ...
  async execute(input, ctx) {
    ...
    const request = workerRequest.parse(stationRequest(ctx));
