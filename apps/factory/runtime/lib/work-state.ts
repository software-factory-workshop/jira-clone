...
export interface WorkState {
 sandboxStarted:boolean; prepared:boolean; revision:string; prepareAttempts:number; prepareFailure:null|{message:string;code?:string;at:string};
...
export const workState=defineState<WorkState>("factory.work",()=>({sandboxStarted:false,prepared:false,revision:"",prepareAttempts:0,prepareFailure:null,jiraManifest:"",jiraNuxtConfig:"",jiraLockfile:"",baseline:[],commands:[],pull:null,publication:null,operationId:"",activeBrief:"",targetBranch:"main",targetHeadSha:"",mergeTarget:false,completedOperations:{},basePrepared:false,verificationFindings:[],contextGaps:[],recorded:false,verifiedDigest:null,reviewVerified:false}));
