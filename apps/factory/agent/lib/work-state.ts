...
export interface WorkState {
 ...
 jiraManifest:string; baseline:Array<{file:string;sha256:string}>; commands:CommandEvidence[];
...
export const workState=defineState<WorkState>("factory.work",()=>({sandboxStarted:false,prepared:false,revision:"",jiraManifest:"",baseline:[],commands:[],pull:null,publication:null,operationId:"",activeBrief:"",targetBranch:"main",targetHeadSha:"",mergeTarget:false,completedOperations:{},contextGaps:[],recorded:false,verifiedDigest:null,reviewVerified:false}));
