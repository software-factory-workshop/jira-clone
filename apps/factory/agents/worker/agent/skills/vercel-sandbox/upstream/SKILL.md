---
name: vercel-sandbox
description: Run untrusted or AI-generated code in ephemeral Firecracker
  microVMs with @vercel/sandbox. Create a VM, run commands, read/write files,
  expose ports, snapshot and resume. Use for AI agents, code execution, builds,
