...
The cockpit supports on-demand task mining, editable work requests, inspection of project context, and the factory's next capability. Updated 12 September 2026 after hosted Eve verification; see [the evidence](verification.md).

## Initial features

| Feature | Why it earns its place now | Current behavior |
| --- | --- | --- |
| Task mining | Understand useful work before implementation | Eve investigation in a Sandbox, source and GitHub evidence, durable report replay, draft handoff |
