...
The cockpit supports on-demand task mining, editable work requests, and a human-controlled GitHub handoff. Updated 12 September 2026 during the native Eve migration; see [dated verification](verification.md) for tested behavior.
...
| Work requests | A stable work object can later connect attempts and decisions | Title, brief and local save/reopen |
| GitHub handoff | Work and factory changes should have a shared repository home | Repository links and prefilled issue composition for human submission |
...
Product direction recorded on 12 September 2026: the task-mining station is the proposal surface for useful next work.
...
1. Open Work, edit a request and save. Reload and reopen it.
2. Inspect the Jira list, board and issue details. Use these to give taste and product feedback.
3. Run a mining investigation, inspect its evidence, and review whether its proposals are useful. Use findings in a draft to refine a candidate; execution remains a separate decision.
